...
class App {
  ...
  async init(cfg) {
    ...
    this.app.post("/orgchart/update", orgchart.createUpdateHandler());
    this.app.post("/orgchart/delete/:userId", orgchart.createDeleteHandler());
    this.app.post("/orgchart/bulk", orgchart.createBulkHandler());
  }
